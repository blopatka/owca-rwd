...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
  ...
  <!-- END not_logged_in -->
	...
	<tr> 
		...
		<small>Sprzedam - podaj cenê sprzeda¿y<br>
		Kupiê - podaj maksymaln± cenê, jak± chcesz zap³aciæ<br>
		Oddam za darmo - wpisz 0<br>
    Przyjmê - wpisz 0</small></span><br><br><input name="price" type="text" size="60" value="Je¶li nie podajê ceny, to znaczy, ¿e oddajê za darmo!" onBlur="if(this.value == '') { this.value = 'Wpisz ca³kowit± wartosæ liczbow±! (waluta to PLN)'; this.style.color = '#707070'; }" onFocus="if(this.value == 'Wpisz ca³kowit± wartosæ liczbow±! (waluta to PLN)') { this.value = ''; this.style.color = '#000000'; }" maxlength="50" style="border: solid #000000 1px"><br><br><small>Poprawny wpis: 1540<br>B³êdny wpis: 1540,50</small></td>
	</tr>
