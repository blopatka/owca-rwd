...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/css/bootstrap.min.css?v=7" />
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/{T_HEAD_STYLESHEET}?v=7" />
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/css/bootstrap-theme.min.css?v=7" />
</head>
