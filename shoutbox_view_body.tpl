...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/css/bootstrap.min.css?v=9" />
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/{T_HEAD_STYLESHEET}?v=9" />
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/css/bootstrap-theme.min.css?v=9" />
</head>
