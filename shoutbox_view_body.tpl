...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/css/bootstrap.min.css?v=20" />
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/{T_HEAD_STYLESHEET}?v=20" />
</head>
