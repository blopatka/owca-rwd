...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/css/bootstrap.min.css?v=31" />
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/{T_HEAD_STYLESHEET}?v=31" />
</head>
