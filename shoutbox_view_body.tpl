...
<head>
     ...
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/css/bootstrap.min.css?v=19" />
     <link rel="stylesheet" type="text/css" href="templates/pentaskin/{T_HEAD_STYLESHEET}?v=19" />
</head>
