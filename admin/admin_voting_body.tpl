...
<!-- BEGIN detail --> 
	<tr> 
		<td class="row1">{votes.detail.OPTION}</td> 
...
<div align="center"><span class="copyright">Admin Voting  v1.1.7  &copy 2002  <a href="mailto:ErDrRon@aol.com">ErDrRon</a></span></div>
<div align="center"><span class="copyright">Brazenly adapted from Vote-Teilnehmer anzeigen MOD version 1.2.0 <a href="mailto:Fabro@gmx.net">Fabro</a></span></div>
