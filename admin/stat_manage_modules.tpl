...
<table class="forumline" align="center" width="80%">
	<tr>
		<td class="row3" align="center"><span class="gen"><a href="{U_AUTO_SET}" class="gen">{L_AUTO_SET}</a></td>
	</tr>
</table>

<br />

<table class="forumline" width="100%" align="center" cellpadding="3" cellspacing="1">
	<tr>
		<th align="center">{L_NAME}</td>
		<th align="center">{L_DNAME}</td>
		<th align="center">{L_STATUS}</td>
		<th align="center">{L_UPDATE_TIME}</td>
		<th align="center">&nbsp;</td>
		<th align="center">&nbsp;</td>
	</tr>		
	<!-- BEGIN modulerow -->
