...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr>
	  <td class="row1"><span class="genmed">{L_GD_VERSION}</span><br /><span class="gensmall">{L_GD_VERSION_E}</span></td>
	...
	<tr>
	  <td class="row1"><span class="genmed">{L_WATERMARK}</span><br /><span class="gensmall">{L_WATERMARK_E}</span></td>
	  <td class="row2"><span class="genmed"><input type="text" value="{WM_TRANSPARENT}" name="watermark_transparent" size="4" maxlength="2" class="post" /></span></td>
	</tr>
	<tr>
	  <td class="row1"><span class="genmed">{L_WATERMARK_WIDTH}</span><br /><span class="gensmall">{L_WATERMARK_WIDTH_E}</span></td>
	  <td class="row2"><span class="genmed"><input type="text" value="{WM_WIDTH}" name="watermark_width" size="4" maxlength="4" class="post" /></span></td>
	</tr>
	<tr>
	  <td class="row1"><span class="genmed">{L_WATERMARK_HEIGHT}</span><br /><span class="gensmall">{L_WATERMARK_HEIGHT_E}</span></td>
	  <td class="row2"><span class="genmed"><input type="text" value="{WM_HEIGHT}" name="watermark_height" size="4" maxlength="4" class="post" /></span></td>
	</tr>
