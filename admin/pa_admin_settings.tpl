...
<!--  <tr>
  ...
  <tr>
	<td class="row1">{L_DLINKED}<br><span class="gensmall">{L_DLINKED_E}</span></td>
	<td class="row2"><select name="form[directly_linked]" class="forminput">{DIRECTLY_LINKED}</select></td>
  </tr>
  <tr>
