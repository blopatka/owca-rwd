...
<!-- BEGIN prune_list -->
	<tr> 
		<td class="row1" align="left">{prune_list.S_DAYS2}{prune_list.S_DAYS}</td>
		<td class="row2" align="left">({prune_list.USER_COUNT}){prune_list.TOTAL_USERS}<br/>{prune_list.U_PRUNE}<br/>{prune_list.L_PRUNE_EXPLAIN}</td>	
		<td class="row3" align="left"><span class="gensmall">{prune_list.LIST}</span></td>
	</tr>
<!-- END prune_list -->
</table></form>
