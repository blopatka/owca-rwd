...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
	<tr> 
		<td><a href="{U_CREATE_AD}"><img src="{MSG_NEWAD}" border="0" alt="New ad"></a>
		...
		<td valign="top" width="100%">
			...
			<table width="99%" border="0" cellpadding="2" cellspacing="1" class="forumline">
				...
				<tr>
					...
					<td class="row2"><span class="genmed"><a href="{U_PROFILE}">{USERNAME}</a></span></td>
				</tr>
				...
				<tr>
					...
					<td class="row2"><span class="gen"><br>{ADDITIONAL_INFO}<br><br></span></td>
				</tr>
				<!-- END not_basic_ad -->
				...
				<tr>
					...
					&nbsp;[ <a href="{U_RENEW_AD}"><img src="{ICON_RENEW}" border="0" align="absmiddle" alt="Renew ad"></a> og³oszenie ]
				...
				<tr>
					<td class="row1"><span class="gen">{L_ADVERTISER}</span></td>
					<td class="row2"><span class="gen"><span class="genmed"><a href="{U_PROFILE}">{USERNAME}</a></span>&nbsp;
						 [ <a href="{U_USER_SEARCH}">{L_ALL_SELLERS_ADS} {USERNAME}</a> ]</span></td>
				</tr>

				<!-- BEGIN non_guest_ad --> 
				<tr>
					<td class="row1"><span class="gen">{L_CONTACT} z {USERNAME}</span></td>
