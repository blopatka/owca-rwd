...
<div class="row">
	<div class="col-md-2">
		...
		<div class="dropdown">
			...
			<span class="name"><b>{postrow.POSTER_NAME}</b><!-- BEGIN gender --><img src="{postrow.gender.GENDER}" alt="" border="0"><!-- END gender --></span> <span class="caret"></span>
			</button>
	...
	<div class="col-md-10">
			...
			{L_POSTED}: <time>{postrow.POST_DATE}</time> <b>{postrow.POST_SUBJECT}</b>
		...
		<p class="postbody" {postrow.QUOTE_USERNAME}><hr />{postrow.MESSAGE}{postrow.ATTACHMENTS}</p>
		<!-- BEGIN signature --><p class="postbody signature">{postrow.SIGNATURE}{postrow.SIG_IMAGE}</p><!-- END signature -->
