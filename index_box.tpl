				...
				<tr>
					...
					<!-- END inc -->
					<td class="catHead" width="100%" height="25" colspan="5"><span class="cattitle"><a href="{catrow.cathead.U_VIEWCAT}" class="cattitle">{catrow.cathead.CAT_TITLE}</a></span></td>
				</tr>
				<!-- END cathead -->
				<!-- BEGIN cattitle -->
				<tr>
				...
				<tr>
					...
					<td class="row1" {ONMOUSE_COLORS}width="100%" height="50" colspan="{catrow.forumrow.INC_SPAN}">
						...
						<span class="genmedGLOWNA">{catrow.forumrow.FORUM_DESC}<br /></span>
						<span class="gensmall">
