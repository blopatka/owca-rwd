...
<table border="0" cellpadding="2" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
	  ...
	  <td class="row2" align="left"><span class="gen">{validation.VALIDATION}<br /><input type="text" name="reg_key" class="post" onFocus="Active(this)" onBlur="NotActive(this)" maxlength="12" size="24"></span></td>
	</tr>
	<!-- END validation -->
	<tr>
