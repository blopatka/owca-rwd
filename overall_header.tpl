...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/css/bootstrap.min.css?v=10" />
    <link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/{T_HEAD_STYLESHEET}?v=10" />
	<link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/css/bootstrap-theme.min.css?v=10" />
	<link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/print.css?v=10"  media="print" />
