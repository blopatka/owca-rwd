...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/css/bootstrap.min.css?v=4" />
    <link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/{T_HEAD_STYLESHEET}?v=4" />
	<link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/css/bootstrap-theme.min.css?v=4" />
	<link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/print.css?v=4"  media="print" />
