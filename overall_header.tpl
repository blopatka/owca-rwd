...
<head>
    ...
    <link id="bootstrap-style" rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/css/bootstrap.min.css?v=27" />
    <link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/{T_HEAD_STYLESHEET}?v=27" />
	<link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/print.css?v=27"  media="print" />
    ...
    <script type="text/javascript">
        function setAndSaveTheme(isBlackTheme, saveTheme) {
            ...
            if(direction) {
                document.getElementById('bootstrap-style').href = "templates/pentaskin/css/bootstrap.min.css?v=27";
                $('body').removeClass("nightMode");
                if(saveTheme){Cookies.set("isBlackTheme","0", {expires: 3650});}
            } else {
                document.getElementById('bootstrap-style').href = "templates/pentaskin/css/bootstrap-dark.min.css?v=27";
