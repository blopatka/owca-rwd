...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/css/bootstrap.min.css?v=6" />
    <link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/{T_HEAD_STYLESHEET}?v=6" />
	<link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/css/bootstrap-theme.min.css?v=6" />
	<link rel="stylesheet" type="text/css" href="templates/{STYLE_NAME}/print.css?v=6"  media="print" />
