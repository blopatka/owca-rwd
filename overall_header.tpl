			...
			<tr>				
				<td align="center" width="100%" valign="middle"><a href="{U_INDEX_PORTAL}"><img src="./images/mesuper.gif" border="0" alt="{L_INDEX}"></a>
				 <table width="100%" border="0" cellpadding="2" cellspacing="0" background="templates/pentaskin/images/menu.gif">
					<tr> 
						<td height="34" align="center" valign="middle" nowrap="nowrap"><span class="mainmenu">&nbsp;<a href="{U_FAQ}" class="mainmenu">{L_FAQ}</a>&nbsp; &nbsp;<a href="{U_SEARCH}" class="mainmenu">{L_SEARCH}</a>&nbsp; &nbsp;<a href="{U_MEMBERLIST}" class="mainmenu">{L_MEMBERLIST}</a>&nbsp; &nbsp;<a href="{U_GROUP_CP}" class="mainmenu">{L_USERGROUPS}</a>&nbsp;<!--<a href="http://pentax.org.pl/adverts.php" class="mainmenu"> Gie³da</a>-->&nbsp; <a href="http://pentax.org.pl/kontakt.php" class="mainmenu">Kontakt</a>&nbsp; &nbsp;&nbsp; 
	<!-- ALBUM -->
