...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
	<tr>
		<td class="catHead" align="{LOGIN_ALIGN}" height="25"><span class="genmed"><b>{L_LOGIN}</b></span></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="row2" align="{LOGIN_ALIGN}"><span class="gensmall"><a href="{U_SENDPASSWORD}" class="mainmenu">{L_FORGOTTEN_PASSWORD}</a></span></td>
	</tr>
	<tr>
		<td class="row1" align="{LOGIN_ALIGN}"><span class="gensmall"><a href="{U_REGISTER}" class="mainmenu">{L_REGISTER}</a></span></td>
	</tr>
</table>
</form>
<br />
