...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <!-- BEGIN recent_detail -->
    <td class="row2"><span class="gensmall">{L_PIC_TITLE}: {recent_pics.recent_detail.TITLE}<br />
  	...
  	{L_VIEW}: {recent_pics.recent_detail.VIEW}<br />{recent_pics.recent_detail.RATING}{recent_pics.recent_detail.COMMENTS}</span></td>
  <!-- END recent_detail -->
  </tr>
  <!-- END recent_pics -->
</table>
...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  <tr>
	<th height="25" colspan="{S_COLS}" nowrap="nowrap">The Best Of All</th>
  </tr>
  <!-- BEGIN no_pics -->
  <tr>
	<td class="row1" align="center" colspan="{S_COLS}" height="50"><span class="gen">{L_NO_PICS}</span></td>
  ...
  <!-- BEGIN highest_detail -->
    <td class="row2"><span class="gensmall">{L_PIC_TITLE}: {highest_pics.highest_detail.H_TITLE}<br />
  	...
  	{L_VIEW}: {highest_pics.highest_detail.H_VIEW}<br />{highest_pics.highest_detail.H_RATING}{highest_pics.highest_detail.H_COMMENTS}</span>
	</td>
  <!-- END highest_detail -->
  </tr>
  <!-- END highest_pics -->
