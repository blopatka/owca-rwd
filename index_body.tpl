...
<!-- END custom_registration_bottom -->
   ...
   <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
      ...
      <tr>
         <td class="row1" {ONMOUSE_COLORS}align="center" valign="middle" rowspan="6">
            <img src="templates/pentaskin/images/whosonline.gif" width="46" height="25" alt="" /></td>
      ...
      <tr>
         <td class="row1" {ONMOUSE_COLORS}align="left">
			...
			<!-- END se_separator -->
			<!-- END staff_explain -->
			<!-- <a href="http://pentax.org.pl/topics_anywhere.php?mode=show&out=rss2.0&f=a&n=10&sfn=y&r=y&sr=y&b=non&lpb=0&lpd=0" class="gensmall"><img src="http://pentax.org.pl/templates/pentaskin/RSS.gif" border"0"> RSS</a> -->
			<br />{USERS_OF_THE_DAY_LIST}</span>
      </tr>
      <!-- BEGIN birthday -->
      <tr>
         <td class="row1" {ONMOUSE_COLORS}align="left">
      ...
      <tr>
         <td class="row1" {ONMOUSE_COLORS}align="left">
         <span class="gensmall"><a href="{U_STAFF}" class="gensmall">{L_STAFF}</a><!--kontakt BEGIN--> &bull; <a href="kontakt.php" class="gensmall">Formularz kontaktowy</a><!--kontakt END--></td></span></td>
      </tr>
      <!-- END staff -->
      <!-- BEGIN warnings -->
      <tr>
   ...
   <table cellspacing="4" border="0" align="center" cellpadding="0">
      <tr>
		 ...
		 <td width="20">&nbsp;&nbsp;</td>
		 <td width="20" align="center"><a href="http://pentax.org.pl/topics_anywhere.php?mode=show&out=rss2.0&f=a&n=10&sfn=y&r=y&sr=y&b=non&lpb=0&lpd=0" class="gensmall"><img src="http://pentax.org.pl/templates/pentaskin/RSS.gif" border="0"></a>
		</td>
         <td><span class="gensmall"><a href="http://pentax.org.pl/topics_anywhere.php?mode=show&out=rss2.0&f=a&n=10&sfn=y&r=y&sr=y&b=non&lpb=0&lpd=0" class="gensmall"> RSS</a>
		 <td width="20">&nbsp;&nbsp;</td>
		 <td width="20" align="center"><a href="http://pentax.org.pl/kontakt.php" class="gensmall"><img src="http://pentax.org.pl/templates/pentaskin/kontakt.jpg" border="0"></a>
		</td>
         <td><span class="gensmall"><a href="http://pentax.org.pl/kontakt.php" class="gensmall"> Kontakt</a>
		</span></td>
