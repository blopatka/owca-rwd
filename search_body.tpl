<table width="100%" cellpadding="1" cellspacing="1" border="0">
	...
	<th class="thHead" colspan="4" height="25">Proszê u¿ywaæ szukajki Google</th>
	<tr>
	    <td align=center>
		<br>
		Wyszukiwarka Google zintegrowana z naszym forum. Przeszukuje wszystkie tematy, nie spowalnia forum - skorzystaj z niej.
		<br><br>
...
<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	<tr> 
		<th class="thHead" colspan="4" height="25">{L_SEARCH_QUERY} - Szukajka Forumowa</th>
	</tr>
	<!-- BEGIN enable_search -->
	<tr> 
	...
	<tr> 
		...
		<td class="row2" valign="middle"><span class="genmed"><select class="post" name="search_time">{S_TIME_OPTIONS}</select>
...
<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	...
	<tr> 
		...
		<td class="row2" colspan="2" valign="top"><span class="genmed"><select class="gensmall" name="search_time">{S_TIME_OPTIONS}</select><br />
